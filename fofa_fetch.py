...
def get_isp(ip):
    if ip.startswith((
        "1.0.1.", "1.0.2.", "1.0.8.", "1.0.32.", "1.0.64.",
        "113.", "114.", "115.", "116.", "117.", "118.", "119.",
        "123.127.", "125.88.", "182.92.", "182.96."
    )):
        return "电信"
    elif ip.startswith((
        "36.", "39.", "42.", "43.", "49.7.", "58.", "59.", "60.", 
        "61.232.", "101.", "103.1.", "106.", "110.", "111."
    )):
        return "联通"
    elif ip.startswith((
        "100.", "101.", "102.", "103.", "104.", "121.", "123.248.",
        "175.", "180.", "182.136.", "183.", "221.176.", "223."
    )):
        return "移动"
    else:
        return "未知"
